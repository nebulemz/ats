  ...
  <div class="card">
    <div class="card-body login-card-body">
      <p class="login-box-msg">Enter Employee ID</p>
        <!-- Add the following button code -->
        <button type="button" class="btn btn-primary btn-block" onclick="redirectToAdminLogin()">ATTENDANCE & PAYROLL SYSTEM</button>
    </div>
      <form method="POST">
...
<!-- Add this script at the bottom, after the jQuery and Bootstrap scripts -->
<script>
    function redirectToAdminLogin() {
        // Get the current page URL
        var currentURL = window.location.href;
        
        // Replace only the last segment of the path with "admin/index.php"
        var adminURL = currentURL.replace(/\/[^/]*$/, '/admin/index.php');
        
        // Redirect to the admin login page URL
